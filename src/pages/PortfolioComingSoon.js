    ...
    <>
      ...
      <section class="body-container">
        ...
        <div class="text-content">
          ...
          <div>
            <p>
              I am in an Age of Exploration — and I always will be. Driven by
              curiosity, adventure, and community my entire life, I approach
              design as an opportunity to craft meaningful experiences for
              users.
            </p>
            <p>
              Check back to see my UI/UX and visual design portfolio, you won't
              regret it!
            </p>
          </div>
        </div>
